# threat-informed-architecture-design-assistant

## Detailed Description

threat-informed-architecture-design-assistant is a security-focused project that evaluates risk signals, policy violations, and suspicious activity for faster incident response.  
